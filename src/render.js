...
const renderData = (stateIndex, sortBy) => {
    ...
    // document.querySelector('#summary-block-delta-active').textContent = '+' + numFormat(newMaster[activeState].deltaactive)
...
export { renderData, populateDropdown, dropdownList }